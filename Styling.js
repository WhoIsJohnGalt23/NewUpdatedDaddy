...
$('.data-table1 td:contains("Titans")').prepend('<img src="http://www.pngmart.com/files/4/Tennessee-Titans-Transparent-PNG.png" width="25" height="21" border="0" alt="Team logo" class="teamLogo">').addClass("ten");
...
$('a>span:contains("LAR")').replaceWith('<img src="https://i.imgur.com/A3z9Mev.png" width="20" height="15"" class="scoreboard"> LAR</span>');
